<template>
  <div class="konten">
    ...
    <div class="mkonten">
      <div>
        <img
          :src="require('@/assets/' + ImgSlide + '.png')"
          style="width: 600px"
          alt=""
        />
      </div>
    ...
    <div>
      ...
      <br />
      <button style="margin-left: 20px; background-color: pink; border-radius: 10px">
        <img src="../assets/cart-icon.png" alt="" /> Add To Chart
      </button>
      <br />
      <br />
      <hr />
      <b style="font-size: 20px; margin-left: 22px"> About the product: </b>
      <br />
      <br />
      <pre>
  ...
  a perfect solution for the way we work today.
